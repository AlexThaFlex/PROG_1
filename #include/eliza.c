...
* based on Charles Hayden's Java implementation from http://chayden.net/eliza/Eliza.html
* and on J.P. Marque de Sá C implementation from https://www.fca.pt/pt/catalogo/informatica/programacao/fundamentos-de-programacao-usando-c/
*
* Compilar: clang eliza.c -o eliza
* Executar: ./eliza
*/
...
void print_title(){
    system("clear");
    printf("Welcome to\n");
    printf("\t\tEEEEEE  LL      IIII  ZZZZZZZ   AAAAA\n");
    printf("\t\tEE      LL       II       ZZ   AA   AA\n");
    printf("\t\tEEEEE   LL       II     ZZZ    AAAAAAA\n");
    printf("\t\tEE      LL       II    ZZ      AA   AA\n");
    printf("\t\tEEEEEE  LLLLLL  IIII  ZZZZZZZ  AA   AA\n");
    printf("\n\n");
    print_center("ELIZA is a mock Rogerian psychotherapist.");
    print_center("The original program was described by Joseph Weizenbaum in 1966.");
    print_center("https://en.wikipedia.org/wiki/Joseph_Weizenbaum");
    printf("\n\n");
...
int main(){
	...
	printf("Hi %s, WHAT'S YOUR PROBLEM?\n", name);
    ...
    while (1){ 
        ...
        if (strcmp(lastinput,inputstr)==0){
            printf("PLEASE %s, DON'T REPEAT YOURSELF!\n", name);
            continue;
        }
    ...
    printf( "GOODBYE %s!  THANKS FOR VISITING WITH ME...\n", name);
